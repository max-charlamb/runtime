...
| `ImageDosHeader` | `Lfanew` | `int32` | File offset of the PE signature and NT headers |
| `ImageFileHeader` | `NumberOfSections` | `uint16` | Number of section headers in the image |
| `ImageFileHeader` | `SizeOfOptionalHeader` | `uint16` | Size of the optional header in bytes |
| `ImageFileHeader` | `TimeDateStamp` | `uint32` | Image creation time stamp |
| `ImageNTHeaders` | `FileHeader` | `ImageFileHeader` | Embedded PE file header |
| `ImageNTHeaders` | `OptionalHeader` | `ImageOptionalHeader` | Embedded PE optional header |
| `ImageOptionalHeader` | `SizeOfImage` | `uint32` | Total size of the loaded image in bytes |
| `ImageSectionHeader` | `PointerToRawData` | `uint32` | File offset of the section's raw data |
| `ImageSectionHeader` | `SizeOfRawData` | `uint32` | Size of the section's raw data in the file |
| `ImageSectionHeader` | `VirtualAddress` | `uint32` | Relative virtual address of the section |
...
| `WebcilHeader` | `CoffSections` | `uint16` | Number of COFF section headers in the Webcil image |
| `WebcilHeader` | `VersionMajor` | `uint16` | Major version of the Webcil file format |
| `WebcilSectionHeader` | `PointerToRawData` | `uint32` | File offset of the section's raw data |
| `WebcilSectionHeader` | `SizeOfRawData` | `uint32` | Size of the section's raw data in the file |
| `WebcilSectionHeader` | `VirtualAddress` | `uint32` | Relative virtual address of the section |
| `WebcilSectionHeader` | `VirtualSize` | `uint32` | Size of the section in virtual memory |
