...
| `Array` | `Size` | `uint32` | Size of the fixed portion of an array object |
...
| `Delegate` | `InvocationCount` | `nint` | Invocation count (non-zero for multicast, wrapper, unmanaged, or special delegates) |
...
| `ObjectHeader` | `Size` | `uint32` | Size of the object header |
